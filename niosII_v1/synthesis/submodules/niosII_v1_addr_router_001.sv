...
(
    ...
    localparam PAD2 = log2ceil(64'h2002000 - 64'h2001000); 
    localparam PAD3 = log2ceil(64'h2003000 - 64'h2002800); 
    ...
    // ( 0x2002800 .. 0x2003000 )
    if ( {address[RG:PAD3],{PAD3{1'b0}}} == 26'h2002800   ) begin
            src_channel = 6'b000001;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 3;
    end

    // ( 0x2003000 .. 0x2003010 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 26'h2003000   ) begin
